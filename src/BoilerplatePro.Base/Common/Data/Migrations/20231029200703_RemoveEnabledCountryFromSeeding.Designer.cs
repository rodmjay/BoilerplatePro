...
namespace BoilerplatePro.Base.common.data.migrations
{
    ...
    [Migration("20231029200703_RemoveEnabledCountryFromSeeding")]
    partial class RemoveEnabledCountryFromSeeding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 10, 29, 20, 7, 3, 504, DateTimeKind.Utc).AddTicks(947),
                            DisplayName = "My API",
                            Emphasize = false,
                            Enabled = true,
                            Name = "api1",
