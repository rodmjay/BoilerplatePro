...
namespace BoilerplatePro.Base.common.data.migrations
{
    ...
    [Migration("20231029233408_AddedCountryTimezoneRelationship")]
    partial class AddedCountryTimezoneRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Currencies.Entities.CountryCurrency", b =>
                {
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Currencies.Entities.Currency", b =>
                {
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Languages.Entities.LanguageCountry", b =>
                {
                    b.Property<string>("Iso2")
                        .HasColumnType("nvarchar(2)");
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Timezones.Entities.CountryTimezone", b =>
                {
                    b.Property<string>("Iso2")
                        .HasColumnType("nvarchar(2)");
                    ...
                    b.HasKey("Iso2", "TimezoneCode");

                    b.HasIndex("TimezoneCode", "TimezoneName");
                    ...
                    b.HasData(
                        new
                        {
                            Iso2 = "US",
                            TimezoneCode = "EST",
                            TimezoneName = "Eastern Standard Time (North America)"
                        },
                        new
                        {
                            Iso2 = "US",
                            TimezoneCode = "CST",
                            TimezoneName = "Central Standard Time (North America)"
                        },
                        new
                        {
                            Iso2 = "US",
                            TimezoneCode = "MST",
                            TimezoneName = "Mountain Standard Time (North America)"
                        },
                        new
                        {
                            Iso2 = "US",
                            TimezoneCode = "PST",
                            TimezoneName = "Pacific Standard Time (North America)"
                        },
                        new
                        {
                            Iso2 = "US",
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Timezones.Entities.Timezone", b =>
                {
                    b.Property<string>("Code")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Users.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Users.Entities.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Users.Entities.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Users.Entities.UserLogin", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Users.Entities.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Users.Entities.UserToken", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 10, 29, 23, 34, 8, 175, DateTimeKind.Utc).AddTicks(5192),
                            DisplayName = "My API",
                            Emphasize = false,
                            Enabled = true,
                            Name = "api1",
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Currencies.Entities.CountryCurrency", b =>
                {
                    b.HasOne("BoilerplatePro.Base.Currencies.Entities.Currency", "Currency")
                        .WithMany("Countries")
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Languages.Entities.LanguageCountry", b =>
                {
                    b.HasOne("BoilerplatePro.Base.Languages.Entities.Language", "Language")
                        .WithMany("Countries")
                        .HasForeignKey("Code3")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Timezones.Entities.CountryTimezone", b =>
                {
                    ...
                    b.HasOne("BoilerplatePro.Base.Timezones.Entities.Timezone", "Timezone")
                        .WithMany("Countries")
                        .HasForeignKey("TimezoneCode", "TimezoneName");
            ...
            modelBuilder.Entity("BoilerplatePro.Base.Users.Entities.RoleClaim", b =>
                {
                    b.HasOne("BoilerplatePro.Base.Users.Entities.Role", "Role")
                        .WithMany("RoleClaims")
