...
using BoilerplatePro.Base.IdentityServer.Builders;
using BoilerplatePro.Base.IdentityServer.Services;
...
namespace BoilerplatePro.Base.IdentityServer.Extensions
{
